	...
	render : function(){
		return (
			React.createElement("div", {className: "contentMine content"}, 
				...
				React.createElement(MineContentDivOut, {books: books.borrowBooks})
			)
		);
...
var MineContentDivOut = React.createClass({displayName: "MineContentDivOut",
	render : function(){
		var books = this.props.books.map(function(book){
			return (
				React.createElement(MineContentDiv, React.__spread({},  book))
			);
	...
	render : function(){
		return (
			React.createElement("div", {className: "mineContentDiv"}, 
				...
				React.createElement(MineContentDivFont, React.__spread({page: this.props.page},  this.props.book))
			)
