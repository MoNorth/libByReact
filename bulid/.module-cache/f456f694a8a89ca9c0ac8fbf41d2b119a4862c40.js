	...
	render : function(){
		...
		return (
			React.createElement("div", {className: "contentIndex content"}, 
				React.createElement("img", {src: src, className: "hotBook"}), 	
				React.createElement(IndexContentBooks, React.__spread({},  other))
			)
		);
	}
});
	...
	render : function(){
		...
		return (
			React.createElement("div", {className: "contentBook"}, 
				...
				React.createElement(IndexContentBooksDiv, React.__spread({},  bottom))
			)
		);
	}
});
